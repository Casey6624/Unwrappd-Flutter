...
class BottomCurve extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(size.width, 0, size.width * 0.94, -0.02, size.width * 0.82,
        size.height * 0.16);
    path.cubicTo(size.width * 0.67, size.height * 0.34, size.width * 0.56,
        size.height * 0.31, size.width * 0.32, size.height * 0.12);
    path.cubicTo(
        size.width * 0.16, 0, 0, size.height * 0.28, 0, size.height * 0.28);
    path.cubicTo(0, size.height * 0.28, 0, size.height, 0, size.height);
    path.cubicTo(
        0, size.height, size.width, size.height, size.width, size.height);
    path.cubicTo(size.width, size.height, size.width, size.height * 0.56,
